...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post boats_url, params: { boat: { harbour: @boat.harbour, name: @boat.name, owner: @boat.owner } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { harbour: @boat.harbour, name: @boat.name, owner: @boat.owner } }
